 ...
 */
export const PUBLISHED_IMAGE_REPO = "ardurai/ardur-bot";
...
export const IMAGE_TAG_ENV = "ARDURBOT_IMAGE_TAG";
export const PREVIOUS_IMAGE_TAG_ENV = "ARDURBOT_IMAGE_TAG_PREVIOUS";
 ...
 */
export const DEFAULT_COMPOSE_PROJECT_NAME = "ardurbot-prod";
export const COMPOSE_PROJECT_NAME_ENV = "COMPOSE_PROJECT_NAME";
export const COMPOSE_PROJECT_NAME_OVERRIDE_ENV = "ARDURBOT_COMPOSE_PROJECT_NAME";
 ...
 * absent because neither uses the Ardur Bot image.
 */
...
/**
 * `updaterUrlConfigured` means the API was given `ARDURBOT_UPDATER_URL` (Compose prod always sets
...
export const SOURCE_MANUAL_UPGRADE_COMMANDS = [
  "git pull",
  "pnpm --filter @ardurbot/db migrate",
