import type { AdapterContext, ConnectorEvent, ConnectorTool } from "@ardurbot/adapter-kit";
...
describe("composio tool mapping", () => {
  ...
  it("uses catalog-canonical toolkit slugs without preloading every tool", async () => {
    ...
    expect(
      ...
      { userId: "__ardurbot_catalog__", toolkits: undefined, sessionPreset: undefined },
