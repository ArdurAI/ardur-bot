import type { AdapterContext, ManagedConnectorProvider } from "@ardurbot/adapter-kit";
import { SecretAskPurpose } from "@ardurbot/contracts";
import type { PrismaClient, RunSecretWriter } from "@ardurbot/db";
