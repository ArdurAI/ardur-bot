...
describe("buildPlaywrightPrScreenshotComment", () => {
  const urls = {
    ...
    runUrl: "https://github.com/example/ardurbot/actions/runs/1",
  ...
  it("names NEW frames with direct PNG links and keeps gallery links secondary", () => {
    ...
    expect(body).toContain(
      "[Open screenshot gallery](https://example.com/playwright/prs/452/index.html) · [Dashboard](https://example.com/playwright/index.html) · [CI run](https://github.com/example/ardurbot/actions/runs/1)",
    );
