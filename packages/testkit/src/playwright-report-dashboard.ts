...
<head>
  ...
  <title>Playwright · Ardur Bot</title>
  <style>
    ${SHARED_PAGE_STYLES}
...
<body>
  <main>
    <header>
      <div>
        <p class="eyebrow">Ardur Bot · browser checks</p>
        <h1>Playwright</h1>
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <meta name="color-scheme" content="dark" />
  <title>${mobile ? "Android screenshots" : "Run screenshots"} · Ardur Bot</title>
  <style>
    ${SHARED_PAGE_STYLES}
...
<body>
  <main>
    <header>
      <div>
        <p class="eyebrow">Ardur Bot · visual review</p>
  ...
  <script>
    ...
    const storageKey = "ardurbot-playwright-gallery-columns";
