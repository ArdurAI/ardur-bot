...
export const RemoteComputerActionSchema = /* @__PURE__ */ (() =>
...
export const RemoteComputerCallSchema = /* @__PURE__ */ (() =>
  z.strictObject({
...
export const RemoteDiscoverySchema = /* @__PURE__ */ (() =>
  z.strictObject({ op: z.literal("computer.remote.discover") }))();
export const RemoteKubeconfigSchema = /* @__PURE__ */ (() =>
  z.strictObject({
    op: z.literal("computer.remote.kubeconfig"),
    path: path.optional(),
    context: z.string().min(1).max(256),
  }))();
export const RemoteSecretSchema = /* @__PURE__ */ (() =>
  z.strictObject({
