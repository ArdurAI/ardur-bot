...
export function validateBundleFiles(files) {
...
export async function writeBundleFiles(directory, files) {
...
export async function readBundleFolder(directory) {
...
export function bundleDocument(files, name) {
