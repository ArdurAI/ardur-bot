import type { TransactionalEmail } from "@ardurbot/adapter-kit";
import { bootstrapUserSpace } from "@ardurbot/db";
...
vi.mock("@ardurbot/db", () => ({ bootstrapUserSpace: vi.fn(async () => ({ spaceId: "space-1" })) }));
