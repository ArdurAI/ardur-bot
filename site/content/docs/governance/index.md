---
title: "Governance and encryption"
description: "Governance and encryption are not part of this build yet."
source_path: "docs/governance.md"
---

> [Source: docs/governance.md](https://github.com/ArdurAI/ardur-bot/blob/__ARDUR_BOT_SOURCE_REF__/docs/governance.md). Edit the source file, then run `python3 site/scripts/sync_docs.py` to refresh this page.
