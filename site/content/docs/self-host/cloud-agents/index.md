...
description: "Cloud agents delegate a repository task to a hosted coding agent and track its result in the bot's chat. They are separate from the bot computer and its in-turn subagents. Web,…"
source_path: "docs/self-host/cloud-agents.md"
---

> [Source: docs/self-host/cloud-agents.md](https://github.com/ArdurAI/ardur-bot/blob/__ARDUR_BOT_SOURCE_REF__/docs/self-host/cloud-agents.md). Edit the source file, then run `python3 site/scripts/sync_docs.py` to refresh this page.
