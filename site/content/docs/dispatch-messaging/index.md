---
title: "Dispatch over chat"
description: "Telegram, Discord and Slack can send work to a running home without an inbound public port."
source_path: "docs/dispatch-messaging.md"
---

> [Source: docs/dispatch-messaging.md](https://github.com/ArdurAI/ardur-bot/blob/__ARDUR_BOT_SOURCE_REF__/docs/dispatch-messaging.md). Edit the source file, then run `python3 site/scripts/sync_docs.py` to refresh this page.
