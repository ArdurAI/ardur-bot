---
title: "ADR-001: Fork Rakazo, rename fully, track upstream with a script"
description: "Status: accepted (2026-09-23)"
source_path: "docs/decisions/ADR-001-fork-and-rename.md"
---

> [Source: docs/decisions/ADR-001-fork-and-rename.md](https://github.com/ArdurAI/ardur-bot/blob/__ARDUR_BOT_SOURCE_REF__/docs/decisions/ADR-001-fork-and-rename.md). Edit the source file, then run `python3 site/scripts/sync_docs.py` to refresh this page.
