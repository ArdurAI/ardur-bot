---
title: "ADR-002: Pins are promises — fail-closed model pins, per-bot runtimes, and subscriptions through the vendors' own binaries"
description: "Status: proposed (2026-09-23)"
source_path: "docs/decisions/ADR-002-runtime-pins.md"
---

> [Source: docs/decisions/ADR-002-runtime-pins.md](https://github.com/ArdurAI/ardur-bot/blob/__ARDUR_BOT_SOURCE_REF__/docs/decisions/ADR-002-runtime-pins.md). Edit the source file, then run `python3 site/scripts/sync_docs.py` to refresh this page.
...
6. **Packaged deployments reach host binaries through a narrowly authorised host service**
   ...
   and login-profile failures without credentials. See [host environment policy](/docs/host-service/#owner-environment-and-tool-inventory).
