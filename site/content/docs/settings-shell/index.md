...
description: "`apps/web/src/pages/settings-sections.ts` is the only section registry. Each line describes one lazy section. The shell does not import pages eagerly or switch on page…"
source_path: "docs/settings-shell.md"
---

> [Source: docs/settings-shell.md](https://github.com/ArdurAI/ardur-bot/blob/__ARDUR_BOT_SOURCE_REF__/docs/settings-shell.md). Edit the source file, then run `python3 site/scripts/sync_docs.py` to refresh this page.
