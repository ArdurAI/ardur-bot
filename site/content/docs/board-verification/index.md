---
title: "Board verification — 2026-09-24"
description: "The PostgreSQL follow-up used the cached postgres:16-alpine image on a loopback"
source_path: "docs/board-verification.md"
---

> [Source: docs/board-verification.md](https://github.com/ArdurAI/ardur-bot/blob/__ARDUR_BOT_SOURCE_REF__/docs/board-verification.md). Edit the source file, then run `python3 site/scripts/sync_docs.py` to refresh this page.
...
All calls use the child-only environment documented in [Board](/docs/board/).
