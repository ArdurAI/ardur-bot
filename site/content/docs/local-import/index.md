---
title: "Import local tool data"
description: "The deployment owner can open Settings → Customize → Import to find instructions, memories,"
source_path: "docs/local-import.md"
---

> [Source: docs/local-import.md](https://github.com/ArdurAI/ardur-bot/blob/__ARDUR_BOT_SOURCE_REF__/docs/local-import.md). Edit the source file, then run `python3 site/scripts/sync_docs.py` to refresh this page.
