---
title: "Fleet P1"
description: "Fleet lets the operator place a computer where capacity is available. Builders keep their"
source_path: "docs/fleet.md"
---

> [Source: docs/fleet.md](https://github.com/ArdurAI/ardur-bot/blob/__ARDUR_BOT_SOURCE_REF__/docs/fleet.md). Edit the source file, then run `python3 site/scripts/sync_docs.py` to refresh this page.
...
[where bots run](/docs/self-host-guide/#where-bots-run) covers each way of installing.
...
[computer runtime](/docs/computer-runtime/#daytona-backend).
