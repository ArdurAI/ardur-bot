---
title: "Reusable API credentials"
description: "Ask a bot to connect an API using a key or password. It calls `request_secret` with a reference name and an HTTPS service origin. The protected card shows that origin before you…"
source_path: "docs/bot-secrets.md"
---

> [Source: docs/bot-secrets.md](https://github.com/ArdurAI/ardur-bot/blob/__ARDUR_BOT_SOURCE_REF__/docs/bot-secrets.md). Edit the source file, then run `python3 site/scripts/sync_docs.py` to refresh this page.
