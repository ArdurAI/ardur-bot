---
title: "Delegation admission"
description: "Every new direct message, group handoff, helper and lasting child enters through"
source_path: "docs/delegation/README.md"
---

> [Source: docs/delegation/README.md](https://github.com/ArdurAI/ardur-bot/blob/__ARDUR_BOT_SOURCE_REF__/docs/delegation/README.md). Edit the source file, then run `python3 site/scripts/sync_docs.py` to refresh this page.
