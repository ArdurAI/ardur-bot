---
title: "Computer profiles, Podman, and Kubernetes"
description: "For Fleet targets, capacity, placement, transport limits and verification, see [Fleet P1](fleet.md)."
source_path: "docs/compute-profiles.md"
---

> [Source: docs/compute-profiles.md](https://github.com/ArdurAI/ardur-bot/blob/__ARDUR_BOT_SOURCE_REF__/docs/compute-profiles.md). Edit the source file, then run `python3 site/scripts/sync_docs.py` to refresh this page.
