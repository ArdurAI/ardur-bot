---
title: "Mobile AI data sharing: release and review"
description: "The mobile client obtains permission before uploading attachments, submitting messages,"
source_path: "docs/ai-data-sharing-review.md"
---

> [Source: docs/ai-data-sharing-review.md](https://github.com/ArdurAI/ardur-bot/blob/__ARDUR_BOT_SOURCE_REF__/docs/ai-data-sharing-review.md). Edit the source file, then run `python3 site/scripts/sync_docs.py` to refresh this page.
...
- Self-hosters can set `PRIVACY_POLICY_URL` to their own absolute HTTP(S) policy URL. Otherwise
  the mobile flow links Ardur Bot's policy, which distinguishes hosted and self-hosted operators.
