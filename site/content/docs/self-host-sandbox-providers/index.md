---
title: "Self-host sandbox / computer providers"
description: "`SANDBOX_PROVIDER` selects where bot computers run. Workspace bots share a Team Computer by"
source_path: "docs/self-host-sandbox-providers.md"
---

> [Source: docs/self-host-sandbox-providers.md](https://github.com/ArdurAI/ardur-bot/blob/__ARDUR_BOT_SOURCE_REF__/docs/self-host-sandbox-providers.md). Edit the source file, then run `python3 site/scripts/sync_docs.py` to refresh this page.

`SANDBOX_PROVIDER` selects where bot computers run. Workspace bots share a Team Computer by
default; Private Computers are optional. See [computer runtime and isolation](/docs/computer-runtime/)
...
Published-images [Compose](https://github.com/ArdurAI/ardur-bot/blob/__ARDUR_BOT_SOURCE_REF__/infra/compose/docker-compose.images.yml) defaults to **`docker`**.
