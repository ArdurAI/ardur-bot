---
title: "Board"
description: "Board lets an operator create dependent work, find work that can start, assign it"
source_path: "docs/board.md"
---

> [Source: docs/board.md](https://github.com/ArdurAI/ardur-bot/blob/__ARDUR_BOT_SOURCE_REF__/docs/board.md). Edit the source file, then run `python3 site/scripts/sync_docs.py` to refresh this page.
...
See [verification evidence](/docs/board-verification/) for the tested commands,
