...
import { LOCAL_SETTINGS_RPC, LOCAL_SETTINGS_TOKEN_HEADER } from "@ardurbot/contracts";
    ...
    expect(() =>
      execFileSync(
        ...
        [
          ...
          "--input-type=module",
          "-e",
          'import { LOCAL_SETTINGS_PAGE, isLocalSettingsProcedure } from "@ardurbot/contracts/local-settings"; if (LOCAL_SETTINGS_PAGE !== "/desktop-settings" || !isLocalSettingsProcedure("/api/desktop-settings/rpc/me")) throw new Error("Invalid runtime contract");',
        ],
