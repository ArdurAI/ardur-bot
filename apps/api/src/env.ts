...
export function loadEnv(source: NodeJS.ProcessEnv = process.env): AppEnv {
  ...
  return {
    ...
    desktopStackToken: optional(source.ARDURBOT_DESKTOP_STACK_TOKEN),
    authSecret,
    ...
    teamChatBotId: optional(source.TEAM_CHAT_BOT_ID) ?? optional(source.SLACK_ARDURBOT_BOT_ID),
    ...
    gitSha: optional(source.GIT_SHA) ?? optional(source.ARDURBOT_GIT_SHA),
    updaterUrl,
    updaterToken,
    imageTag: optional(source.ARDURBOT_IMAGE_TAG),
  };
}
