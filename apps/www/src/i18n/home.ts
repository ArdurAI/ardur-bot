...
const HOME_COPY: Record<Locale, HomeCopy> = {
  en: {
    title: "Ardur Bot | Open source Grok Bot alternative",
    description: SITE_DESCRIPTION,
    ogImageAlt:
      "Ardur Bot. AI teammates you actually own. Your keys, your model, your machine.",
    ...
    hero: {
      ...
      lead: "Ardur Bot is an open source Grok Bot alternative. Give a bot real work. It signs in to your tools, uses them the way you do, and comes back when it needs you.",
    ...
    selfHost: {
      ...
      copy: "Run Ardur Bot on your machine. Your keys, your model, your data.",
      features: [
        {
    ...
    openSource: {
      ...
      copy: "Ardur Bot is Apache-2.0 licensed and runs on your own machine with your own model keys. Nothing is gated, nothing phones home.",
    ...
    cta: {
      ...
      copy: "Give Ardur Bot something you have been putting off and let it handle the follow-through.",
      getStarted: "Get started",
      viewOnGithub: "View on GitHub",
    ...
    getStartedDialog: {
      ...
      cloudHint: "Hosted Ardur Bot is coming. Leave your email.",
      back: "Back",
      successTitle: "You're in.",
      successCopy:
        "We'll email you when hosted Ardur Bot is ready. Want to start today? Jump to Self-host on this page.",
      done: "Done",
      viewOnGithub: "View on GitHub",
    },
    waitlist: {
  ...
  de: {
    title: "Ardur Bot | Open-Source-Alternative zu Grok Bot",
    description:
      "Ardur Bot ist eine Open-Source-Alternative zu Grok Bot für persistente KI-Teamkollegen, die echte Arbeit erledigen. Deine Keys, dein Modell, deine Maschine.",
    ogImageAlt:
      "Ardur Bot. KI-Teamkollegen, die dir wirklich gehören. Deine Keys, dein Modell, deine Maschine.",
    availableLanguage: "German",
    skipToContent: "Zum Inhalt springen",
    starFallback: "Star",
    nav: {
      home: "Ardur Bot-Startseite",
    ...
    hero: {
      ...
      lead: "Ardur Bot ist eine Open-Source-Alternative zu Grok Bot. Gib einem Bot echte Arbeit. Er meldet sich in deinen Tools an, nutzt sie wie du. Er kommt zurück, wenn er dich braucht.",
      getStarted: "Loslegen",
      viewOnGithub: "Auf GitHub ansehen",
    ...
    selfHost: {
      ...
      copy: "Betreibe Ardur Bot auf deiner Maschine. Deine Keys, dein Modell, deine Daten.",
      features: [
        {
    ...
    openSource: {
      ...
      copy: "Ardur Bot ist Apache-2.0-lizenziert und läuft auf deiner Maschine mit deinen Model-Keys. Nichts ist freigeschaltet, nichts telefoniert nach Hause.",
      selfHostTitle: "Self-host",
    ...
    cta: {
      ...
      copy: "Gib Ardur Bot etwas, das du aufgeschoben hast. Lass es den Follow-through übernehmen.",
      getStarted: "Loslegen",
      viewOnGithub: "Auf GitHub ansehen",
      openSourceValue: "Open Source",
      selfHostValue: "Self-host",
    ...
    getStartedDialog: {
      ...
      cloudHint: "Gehostetes Ardur Bot kommt. Hinterlasse deine E-Mail.",
      back: "Zurück",
      successTitle: "Du bist dabei.",
      successCopy:
        "Wir mailen dir, wenn gehostetes Ardur Bot bereit ist. Heute starten? Zum Self-host-Abschnitt auf dieser Seite.",
      done: "Fertig",
      viewOnGithub: "Auf GitHub ansehen",
    },
    waitlist: {
  ...
  ko: {
    title: "Ardur Bot | 오픈소스 Grok Bot 대안",
    description:
      "Ardur Bot는 실제 업무를 수행하는 지속형 AI 팀원을 위한 오픈소스 Grok Bot 대안입니다. 키, 모델, 머신, 모두 당신 것.",
    ogImageAlt: "Ardur Bot. 진짜로 내 것인 AI 팀원. 키, 모델, 머신, 모두 당신 것.",
    ...
    hero: {
      ...
      lead: "Ardur Bot는 오픈소스 Grok Bot 대안입니다. 봇에게 실제 업무를 맡기세요. 봇이 도구에 로그인하고, 당신처럼 사용하며, 필요할 때 돌아와 묻습니다.",
      getStarted: "시작하기",
      viewOnGithub: "GitHub에서 보기",
    ...
    selfHost: {
      eyebrow: "셀프 호스트",
      heading: "컴퓨터는 당신 것",
      copy: "당신 머신에서 Ardur Bot를 실행하세요. 키, 모델, 데이터는 모두 당신 것.",
      features: [
        {
    ...
    openSource: {
      ...
      copy: "Ardur Bot는 Apache-2.0 라이선스이며, 당신 머신에서 당신 모델 키로 실행됩니다. 잠긴 기능도, 외부로 연락하는 것도 없습니다.",
    ...
    cta: {
      heading: "첫 봇을 만나보세요",
      copy: "미뤄 두었던 일을 Ardur Bot에 맡기고, 후속까지 맡기세요.",
      getStarted: "시작하기",
      viewOnGithub: "GitHub에서 보기",
    ...
    getStartedDialog: {
      ...
      cloudHint: "호스팅 Ardur Bot가 곧 옵니다. 이메일을 남겨 주세요.",
      back: "뒤로",
      successTitle: "등록되었습니다.",
      successCopy:
        "호스팅 Ardur Bot가 준비되면 메일로 알려 드립니다. 오늘 시작하려면 이 페이지의 셀프 호스트 섹션으로 이동하세요.",
      done: "완료",
      viewOnGithub: "GitHub에서 보기",
    },
    waitlist: {
  ...
  zh: {
    title: "Ardur Bot | 开源 Grok Bot 替代品",
    description:
      "Ardur Bot 是一个开源 Grok Bot 替代品，用于运行真正干活的持久化 AI 队友。密钥、模型、机器，都归你所有。",
    ogImageAlt: "Ardur Bot：真正属于你的 AI 队友。密钥、模型、机器，都归你所有。",
    ...
    hero: {
      ...
      lead: "Ardur Bot 是一个开源 Grok Bot 替代品。把真正的工作交给 Bot：它会登录你的工具，像你一样使用它们，并在需要你时回来询问。",
      getStarted: "开始使用",
      viewOnGithub: "在 GitHub 上查看",
    ...
    selfHost: {
      eyebrow: "自托管",
      heading: "电脑归你所有",
      copy: "在你自己的机器上运行 Ardur Bot。密钥、模型、数据，都归你所有。",
      features: [
        {
          title: "任意模型，密钥归你",
    ...
    openSource: {
      ...
      copy: "Ardur Bot 采用 Apache-2.0 许可证，在你自己的机器上用你自己的模型密钥运行。没有功能墙，也不会偷偷外联。",
      selfHostTitle: "自托管",
      selfHostMeta: "现已可用",
      selfHostItems: [
        "Docker 运行器和沙箱浏览器",
    ...
    cta: {
      heading: "认识你的第一个 Bot",
      copy: "把一件你一直拖延的事交给 Ardur Bot，让它负责跟进到底。",
      getStarted: "开始使用",
      viewOnGithub: "在 GitHub 上查看",
      openSourceValue: "开源",
      selfHostValue: "自托管",
    ...
    getStartedDialog: {
      ...
      cloudHint: "托管版 Ardur Bot 即将推出。留下你的邮箱。",
      back: "返回",
      successTitle: "登记成功。",
      successCopy:
        "托管版 Ardur Bot 就绪时我们会邮件通知你。想今天就上手？跳到本页的自托管部分。",
      done: "完成",
      viewOnGithub: "在 GitHub 上查看",
    },
    waitlist: {
