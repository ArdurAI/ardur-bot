...
it("keeps optional screens, Board, Fleet, Dashboard widgets and runtime contracts out of the initial import graph", () => {
  ...
  for (const file of [
    ...
    "pages/ChatTaskReview.tsx",
    "pages/DelegationLines.tsx",
    "pages/CompareStart.tsx",
    "pages/ComparePanel.tsx",
    "pages/board/Board.tsx",
    "pages/board/BoardColumns.tsx",
    "pages/board/BoardsSettings.tsx",
    "pages/dashboard/WorkPanel.tsx",
    ...
    "pages/dashboard/RoutinesPanel.tsx",
    "pages/dashboard/UsagePanel.tsx",
