...
export const settingsSections: SettingsRegistration[] = [
  ...
  { id: "storage", group: "Desktop app", label: msg`Storage`, icon: HardDrive, component: lazy(() => import("./storage/StorageSettings")), available: desktopOnly },
  { id: "extensions", group: "Desktop app", label: msg`Extensions`, icon: Blocks, component: lazy(() => import("./customize/ExtensionsPage")), available: desktopOnly },
  { id: "developer", group: "Desktop app", label: msg`Developer`, icon: Code, component: lazy(() => import("./customize/DeveloperPage")), available: desktopOnly },
  ...
  { id: "boards", group: "Customize", label: msg`Boards`, searchLabels: [msg`Default board`, msg`Beads`, msg`Registered folders`, msg`Allowed bots`, msg`Bots keep the board and memory current`, msg`Learning review`], icon: Blocks, component: lazy(() => import("./board/BoardsSettings")), available: ownerOnly },
