...
export function WelcomePage() {
  ...
  return (
    <div className="flex min-h-full flex-col bg-background" data-ardurbot-surface="welcome">
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-11 pb-[90px]">
        <div className="flex items-center gap-[26px]">
          ...
          <div className="text-[76px] leading-none tracking-[-0.03em] text-foreground">Ardur Bot</div>
        </div>
