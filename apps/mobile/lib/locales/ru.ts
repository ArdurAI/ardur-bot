export const RU_MESSAGES: Record<string, string> = {
  ...
  "Choose effort": "Выберите уровень рассуждений",
  "Codex app-server unavailable": "Codex app-server недоступен",
  "Codex sign-in did not finish.": "Вход в Codex не завершён.",
  "Completion not recorded": "Завершение не зафиксировано",
  "Consolidation uses the review connection and may incur model charges. Approval is required.":
    "Объединение памяти использует подключение для проверки и может повлечь расходы на модель. Требуется одобрение.",
  "Continue with ChatGPT": "Продолжить с ChatGPT",
  "Could not load Team; retry.": "Не удалось загрузить команду; попробуйте ещё раз.",
  "Could not load memory. Try again.": "Не удалось загрузить память. Попробуйте ещё раз.",
  "Could not load observations.": "Не удалось загрузить наблюдения.",
  "Could not load the last check.": "Не удалось загрузить последнюю проверку.",
  "Could not update learning. Try again.":
    "Не удалось обновить настройки обучения. Попробуйте ещё раз.",
  "Could not update this task; try again.": "Не удалось обновить задачу; попробуйте ещё раз.",
  Curator: "Куратор",
  Current: "Сейчас",
  Deleted: "Удалено",
  Delta: "Разница",
  ...
  "Export run": "Экспорт запуска",
  Failures: "Ошибки",
  "Feedback corrections": "Исправления по отзывам",
  Flags: "Отметки",
  History: "История",
  "Host service:": "Служба хоста:",
  "Image profile": "Профиль образа",
  Inbox: "Входящие",
  "Last check": "Последняя проверка",
  "Later edits overlap this change. Review both versions in History.":
    "Последующие правки затрагивают это изменение. Сравните обе версии в истории.",
  Learning: "Обучение",
  "Learning is off for this space.": "Обучение отключено для этого пространства.",
  "Load more": "Загрузить ещё",
  "Loading observations…": "Загрузка наблюдений…",
  ...
  Memory: "Память",
  "Memory is read-only here. Edit it in Settings on desktop or web.":
    "Здесь память доступна только для чтения. Измените её в настройках приложения для компьютера или веб-приложения.",
  "No checks yet.": "Проверок пока нет.",
  "Not available on this computer": "Недоступно на этом компьютере",
  "Not enough runs to tell": "Недостаточно запусков для оценки",
  "Not recorded": "Не зафиксировано",
  "Not running — open the desktop app": "Не запущено — откройте приложение для компьютера",
  "Not set up": "Не настроено",
  "Nothing to review.": "Нет предложений для проверки.",
  Observations: "Наблюдения",
  "Possible regression — review undo": "Возможное ухудшение — рассмотрите отмену",
  Proposal: "Предложение",
  Proposals: "Предложения",
  "Propose consolidation": "Предложить объединение",
  "Proposed consolidation": "Предлагаемое объединение",
  Pushed: "Отправлено в репозиторий",
  Reject: "Отклонить",
  "Repository history changed. Review the saved copy on desktop or web.":
    "История репозитория изменилась. Просмотрите сохранённую копию в приложении для компьютера или веб-приложении.",
  "Requested by": "Инициатор:",
  Revision: "Версия",
  ...
  "Saved locally. Indexing failed.": "Сохранено локально. Ошибка индексации.",
  "Saved locally. Indexing pending.": "Сохранено локально. Ожидается индексация.",
  "Saved locally. Sync pending.": "Сохранено локально. Ожидается синхронизация.",
  "Sends memory text to": "Текст памяти отправляется в",
  "Sign-in expired. Connect Codex again.": "Сеанс истёк. Подключите Codex заново.",
  "Source revision": "Исходная версия",
  Stale: "Устарело",
  "Steering corrections": "Уточнения по ходу работы",
  "Syncs to": "Синхронизируется с",
  "Task contracts": "Условия задач",
  "The export could not finish; try again.": "Не удалось завершить экспорт; попробуйте ещё раз.",
  "This computer": "Этот компьютер",
  Timeline: "Хронология",
  Undo: "Отменить",
  Undone: "Отменено",
  Unknown: "Неизвестно",
  "What I learned": "Чему я научился",
  Window: "Период",
  "Working from the last copy": "Используется последняя копия",
  "acting as": "от имени",
  learned: "Усвоено:",
  "model estimate": "оценка модели",
  "suggestions to review": "предложений для проверки",
  "things this week": "за эту неделю",
  tokens: "токенов",
