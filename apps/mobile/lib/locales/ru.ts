export const RU_MESSAGES: Record<string, string> = {
  ...
  "Could not load account settings. Try again.":
    "Не удалось загрузить настройки аккаунта. Повторите попытку.",
  "Could not save changes. Try again.": "Не удалось сохранить изменения. Повторите попытку.",
  "Sign in to edit your profile and manage sessions.":
    "Войдите, чтобы изменить профиль и управлять сеансами.",
  Profile: "Профиль",
  ...
  "This signs out every other session and keeps this one signed in.":
    "Все остальные сеансы будут завершены, а текущий останется активным.",
  "Log out": "Выйти",
  "Require trusted devices": "Требовать доверенные устройства",
  "Local devices": "Локальные устройства",
  "Last seen": "Последняя активность",
  "Needs approval": "Требуется одобрение",
  "Active sessions": "Активные сеансы",
  "Sign in again to manage sessions.": "Войдите снова, чтобы управлять сеансами.",
  Updated: "Обновлено",
  ...
  "Choose effort": "Выбрать глубину рассуждений",
  Close: "Закрыть",
  "Codex app-server unavailable": "Codex app-server недоступен",
  "Codex sign-in did not finish.": "Вход в Codex не завершён.",
  ...
  "Consolidation uses the review connection and may incur model charges. Approval is required.":
    "Объединение использует подключение для проверки и может повлечь расходы на модель. Требуется одобрение.",
  "Continue with ChatGPT": "Продолжить с ChatGPT",
  "Could not load Team; retry.": "Не удалось загрузить команду. Повторите попытку.",
  "Could not load memory. Try again.": "Не удалось загрузить память. Повторите попытку.",
  "Could not load observations.": "Не удалось загрузить наблюдения.",
  "Could not load the last check.": "Не удалось загрузить последнюю проверку.",
  ...
  "Export run": "Экспортировать запуск",
  Failures: "Сбои",
  "Feedback corrections": "Исправления по отзывам",
  Files: "Файлы",
  Flags: "Метки",
  History: "История",
  "Host service:": "Служба компьютера:",
  "Image profile": "Профиль изображений",
  Inbox: "Входящие",
  "Last check": "Последняя проверка",
  "Later edits overlap this change. Review both versions in History.":
    "Последующие правки пересекаются с этим изменением. Сравните обе версии в истории.",
  Learning: "Обучение",
  "Learning is off for this space.": "Обучение отключено для этого пространства.",
  "Load more": "Загрузить ещё",
  "Loading observations…": "Загрузка наблюдений…",
  "Mean elapsed time (ms)": "Среднее время (мс)",
  "Mean tokens": "Среднее число токенов",
  Memory: "Память",
  "Memory is read-only here. Edit it in Settings on desktop or web.":
    "Здесь память доступна только для чтения. Измените её в настройках настольного или веб-приложения.",
  "Needs reconnection": "Нужно подключить заново",
  "No checks yet.": "Проверок пока нет.",
  "Not available on this computer": "Недоступно на этом компьютере",
  "Not enough runs to tell": "Недостаточно запусков для оценки",
  "Not recorded": "Не записано",
  "Not running — open the desktop app": "Не запущено — откройте настольное приложение",
  "Not set up": "Не настроено",
  "Nothing to review.": "Нечего проверять.",
  Observations: "Наблюдения",
  Photos: "Фото",
  "Possible regression — review undo": "Возможно ухудшение — проверьте возможность отмены",
  Proposal: "Предложение",
  Proposals: "Предложения",
  "Propose consolidation": "Предложить объединение",
  "Proposed consolidation": "Предложенное объединение",
  Pushed: "Отправлено",
  Reject: "Отклонить",
  "Repository history changed. Review the saved copy on desktop or web.":
    "История репозитория изменилась. Проверьте сохранённую копию в настольном или веб-приложении.",
  "Requested by": "Кто запросил",
  Revision: "Редакция",
  "Revision and observations": "Редакция и наблюдения",
  "Run now": "Запустить сейчас",
  "Runs on": "Выполняется на",
  "Runtime availability could not be checked.":
    "Не удалось проверить доступность среды выполнения.",
  "Saved locally. GitHub sync failed.": "Сохранено локально. Синхронизация с GitHub не удалась.",
  "Saved locally. Indexing failed.": "Сохранено локально. Индексирование не удалось.",
  "Saved locally. Indexing pending.": "Сохранено локально. Ожидается индексирование.",
  "Saved locally. Sync pending.": "Сохранено локально. Ожидается синхронизация.",
  "Sends memory text to": "Отправляет текст памяти в",
  "Sign-in expired. Connect Codex again.": "Срок входа истёк. Подключите Codex заново.",
  "Slash commands": "Слеш-команды",
  "Source revision": "Исходная редакция",
  Stale: "Устарело",
  "Steering corrections": "Корректировки направления",
  "Syncs to": "Синхронизируется с",
  ...
  Window: "Окно",
  "Working from the last copy": "Работа с последней копией",
  "acting as": "действует как",
  learned: "усвоено",
  "model estimate": "оценка модели",
  "suggestions to review": "предложения для проверки",
  "things this week": "за эту неделю",
  tokens: "токены",
  "Response completions": "Завершение ответа",
  Routines: "Задачи",
  "Approvals needed": "Требуется разрешение",
  ...
  "Connect Ollama from desktop or web.":
    "Подключите Ollama в приложении для компьютера или веб-приложении.",
  Cost: "Стоимость",
  "Could not load comparisons; retry.": "Не удалось загрузить сравнения; попробуйте ещё раз.",
  Duration: "Длительность",
  "Effort: not applicable": "Уровень рассуждений: неприменимо",
  Incomplete: "Не завершено",
  Local: "Локально",
  "Memory differed": "Память различалась",
  Merge: "Объединение",
  "Model version": "Версия модели",
  "No models installed. Pull one to start.":
    "Нет установленных моделей. Скачайте модель, чтобы начать.",
  "None detected": "Не обнаружено",
  "Not reported": "Не указано",
  Off: "Выключено",
  On: "Включено",
  "Reported model": "Указанная модель",
  "Same task": "Одна и та же задача",
  Tokens: "Токены",
  "Tools:": "Инструменты:",
  bots: "бота",
  ...
  None: "Нет",
  Brief: "Сводка",
  "Group brief": "Сводка группы",
  "Routed by default": "Маршрут по умолчанию",
  "Concurrent runs": "Одновременные запуски",
  Context: "Контекст",
  ...
  "Model or memory unavailable": "Модель или память недоступна",
  ...
  "Nothing running": "Нет выполняющихся задач",
  "Waiting for your approval": "Ожидает вашего разрешения",
  Error: "Ошибка",
  ...
  "Folder inside your home": "Папка в домашнем каталоге",
  Import: "Импорт",
  "Import all": "Импортировать всё",
  "Import could not finish. Check this computer is connected, then re-scan.":
    "Не удалось завершить импорт. Убедитесь, что этот компьютер подключён, затем повторите сканирование.",
  Instructions: "Инструкции",
  "Items edited after import were kept.": "Изменённые после импорта элементы сохранены.",
  "MCP servers": "Серверы MCP",
  Memories: "Записи памяти",
  "Memory folders: {folders} · Notes: {notes}": "Папок памяти: {folders} · Заметок: {notes}",
  "Not found": "Не найдено",
  "Other files": "Другие файлы",
  "Plugins and extensions": "Плагины и расширения",
  "Preview {tool} {category}": "Предпросмотр: {tool}, {category}",
  "Re-scan": "Сканировать снова",
  "Remove imported items from {tool}": "Удалить импортированные элементы из {tool}",
  "Save credentials": "Сохранить учётные данные",
  "Set up credentials": "Настроить учётные данные",
  "Set up servers": "Настроить серверы",
  "Some items exceeded the scan limits.": "Некоторые элементы превысили ограничения сканирования.",
  ...
  "Allowed bots": "Разрешённые боты",
  "Archive board": "Архивировать доску",
  "Archive board?": "Архивировать доску?",
  Beads: "Beads",
  "Board files will be kept.": "Файлы доски будут сохранены.",
  "Board status": "Состояние доски",
  Boards: "Доски",
  Confirm: "Подтвердить",
  "Default board": "Доска по умолчанию",
  "Folder board": "Доска папки",
  Follow: "Подписаться",
  Hooked: "Подключено",
  "Item updated": "Задача обновлена",
  "Make default": "Сделать по умолчанию",
  "No board": "Нет доски",
  "No ready work": "Нет готовых задач",
  "Not initialized": "Не инициализировано",
  Pinned: "Закреплено",
  Refresh: "Обновить",
  "Registered folders": "Зарегистрированные папки",
  "Selected bots": "Выбранные боты",
  "Set up a board": "Настроить доску",
  "Space board": "Доска пространства",
  "Start board": "Создать доску",
  "Start board?": "Создать доску?",
  Unfollow: "Отписаться",
  Work: "Работа",
  "Work items": "Рабочие задачи",
  "All bots": "Все боты",
  ...
  "Open the IDE on desktop to edit.": "Для редактирования откройте IDE на компьютере.",
