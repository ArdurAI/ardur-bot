export const ZH_MESSAGES: Record<string, string> = {
  ...
  Checked: "已检查",
  "Choose a model": "选择模型",
  "Choose effort": "选择思考强度",
  "Codex app-server unavailable": "Codex app-server 不可用",
  "Codex sign-in did not finish.": "Codex 登录未完成。",
  "Completion not recorded": "未记录完成情况",
  "Consolidation uses the review connection and may incur model charges. Approval is required.":
    "整理记忆会使用审核连接，可能产生模型费用。需要批准。",
  "Continue with ChatGPT": "使用 ChatGPT 继续",
  "Could not load Team; retry.": "无法加载团队，请重试。",
  "Could not load memory. Try again.": "无法加载记忆。请重试。",
  "Could not load observations.": "无法加载观察记录。",
  ...
  "Last check": "上次检查",
  "Later edits overlap this change. Review both versions in History.":
    "后续编辑与此更改有冲突。请在历史记录中查看两个版本。",
  Learning: "学习",
  "Learning is off for this space.": "此空间已关闭学习功能。",
  "Load more": "加载更多",
  "Loading observations…": "正在加载观察记录…",
  "Mean elapsed time (ms)": "平均耗时（毫秒）",
  "Mean tokens": "平均 token 数",
  ...
  "Not running — open the desktop app": "未运行，请打开桌面应用",
  "Not set up": "未设置",
  "Nothing to review.": "暂无待审核内容。",
  Observations: "观察记录",
  "Possible regression — review undo": "效果可能变差，请考虑撤销",
  Proposal: "建议",
  Proposals: "建议",
  "Propose consolidation": "提出整理建议",
  "Proposed consolidation": "整理建议",
  Pushed: "已推送",
  Reject: "拒绝",
  "Repository history changed. Review the saved copy on desktop or web.":
    "仓库历史已更改。请在桌面端或网页端查看已保存的副本。",
  "Requested by": "请求者",
  Revision: "修订版本",
  "Revision and observations": "修订版本与观察记录",
  "Run now": "立即运行",
  ...
  "Saved locally. Indexing pending.": "已保存在本地。等待索引。",
  "Saved locally. Sync pending.": "已保存在本地。等待同步。",
  "Sends memory text to": "记忆文本发送至",
  "Sign-in expired. Connect Codex again.": "登录已过期。请重新连接 Codex。",
  "Source revision": "来源版本",
  Stale: "已过时",
  "Steering corrections": "引导纠正次数",
  "Syncs to": "同步至",
  "Task contracts": "任务约定",
  "The export could not finish; try again.": "导出未完成，请重试。",
  "This computer": "此电脑",
  Timeline: "时间线",
  Undo: "撤销",
  Undone: "已撤销",
  ...
  "What I learned": "学到的内容",
  Window: "时间范围",
  "Working from the last copy": "正在使用上次的副本",
  "acting as": "代表",
  learned: "已学到",
  "model estimate": "模型估算",
  "suggestions to review": "条待审核建议",
  "things this week": "项新知识（本周）",
  tokens: "token",
